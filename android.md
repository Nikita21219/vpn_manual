...
[Скачать Hiddify из Google Play](https://play.google.com/store/apps/details?id=app.hiddify.com)

Если Google Play недоступен - [скачайте APK](https://github.com/hiddify/hiddify-app/releases/latest/download/Hiddify-Android-universal.apk), откройте скачанный файл и установите приложение. Если Android заблокирует установку, разрешите установку из неизвестных источников в настройках.
...
3. При первом подключении разрешите приложению добавить VPN-конфигурацию
