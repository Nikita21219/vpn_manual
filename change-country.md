...
1. Откройте раздел **Прокси** и нажмите на строку **GLOBAL**
2. Выберите нужную страну из списка
...
## FlClash (macOS / Android)

1. Откройте раздел **Прокси**. На компьютере он в меню слева, на телефоне - вкладка внизу экрана
2. Вверху выберите вкладку **Proxy**
3. Нажмите на плитку с нужной страной - выбранная подсвечивается. Плитка **Auto** означает автоматический выбор самого быстрого сервера
