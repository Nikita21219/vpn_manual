# Clash Meta for Android (альтернатива)

Альтернативное приложение. Основная инструкция для Android - [Hiddify](android.md).
...
[← Вернуться к инструкции для Android](android.md)
