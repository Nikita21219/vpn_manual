...
1. Откройте раздел **Профили** и нажмите на три точки `⋮` у профиля
2. Выберите **Синхронизация**

Обновить сразу все профили можно круговыми стрелками вверху раздела **Профили**.

<img src="images/update-flclash-android.jpg" width="500">
