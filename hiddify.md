...
## Режимы работы (только Windows)

- **System Proxy** - для работы в браузере
- **VPN** - когда весь трафик с ПК адресуется к VPN серверу (например игры, программы)

VPN включён, но не открываются нужные сайты - поменяйте режим на **VPN** (предварительно запустив приложение от имени администратора: правой кнопкой мыши - **Запуск от имени администратора**).
